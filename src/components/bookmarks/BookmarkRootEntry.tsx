...
export function BookmarkRootEntry({
  ...
  const className = cn(
    ...
    variant === 'standard'
      ...
      : 'h-7 max-w-[156px] px-2.5 leading-[1.25] text-foreground/74 hover:bg-foreground/[0.065] hover:text-foreground/90 dark:text-foreground/78 dark:hover:bg-white/[0.075] dark:hover:text-foreground/92',
