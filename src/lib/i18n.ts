...
const EN = {
  ...
  settings: {
    ...
    searchEngineDescription: 'Choose the provider used when searching the web',
    searchIconStyle: 'Search icon',
    searchIconStyleDescription: 'Use one Search icon or the current provider icon in the search bar',
    genericSearchIcon: 'Search',
    providerSearchIcon: 'Provider',
...
const ZH: typeof EN = {
  ...
  settings: {
    ...
    dark: '深色',
    searchEngine: '网络搜索引擎',
    searchEngineDescription: '选择网络搜索时使用的供应商',
    searchIconStyle: '搜索图标',
    searchIconStyleDescription: '搜索栏使用统一 Search 图标，或显示当前供应商图标',
    genericSearchIcon: 'Search',
    providerSearchIcon: '供应商',
