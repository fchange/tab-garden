...
export function paletteToShadcnVars(
  ...
  return {
    ...
    '--theme-popover': isDark ? 'rgb(16, 26, 35)' : '#ffffff',
    '--theme-surface': isDark ? 'rgba(255,255,255,0.055)' : 'rgba(255,255,255,0.38)',
    '--theme-surface-strong': isDark ? 'rgba(255,255,255,0.1)' : 'rgba(255,255,255,0.56)',
    ...
    '--theme-muted': isDark ? 'rgba(255,255,255,0.075)' : 'rgba(0,0,0,0.05)',
